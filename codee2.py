...
**User Goal:**
""" 
        return query_model(prompt + query, "lightning-ai/gpt-oss-120b")
...
{query}
"""
        return query_model(prompt, "openai/gpt-5-nano")
...
{query}
    """
        return query_model(prompt, "google/gemini-2.5-flash-lite-preview-06-17")
    ...
    def response(self):
        ...
        nutrition_plan = self.__NutritionAgent(NutrionAgent_response)
        fitness_plan = self.__FitnessAgent(FitnessAgent_response)
        return {
